    ...
    const plans = [
        {
            ...
            price: "₹7,999/-",
            color: "bg-green-300", // Light Green
        ...
        },
        {
            ...
            price: "₹18,999/-",
            color: "bg-yellow-400", // Gold/Yellow
            textColor: "text-gray-900",
        ...
        <section className="w-full py-20 px-4 md:px-8 bg-secondary">
            <div className="max-w-[1400px] mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
                    {plans.map((plan, i) => (
                        <div key={i} className={`rounded-3xl p-8 flex flex-col h-full shadow-xl hover:scale-105 transition-transform duration-300 ${plan.color} ${plan.textColor}`}>
